...
public class RegularExpressions {
	...
	public static final String CUSTOMER_NAME_FORMAT = "^[A-Za-z\\s]+$";
//	public static final String CUSTOMER_NAME_FORMAT = "^CR\\d{5}";
	public static final String CUSTOMER_ID_FORMAT = "^CR\\d{5}";
	public static final String CARD_NAME_FORMAT = "^[A-Za-z\\s]+$";
